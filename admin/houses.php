...
<head>
	...
	<title>RIZIKI. |Donated Houses  </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Donated Houses</div>
...
{				?>	
										<tr>
                                            ...
                                            <td><?php echo htmlentities($result->street_address);?></td>
											<td><?php echo htmlentities($result->bedrooms);?></td>
                                            <td><?php echo htmlentities($result->accesibility);?></td>
